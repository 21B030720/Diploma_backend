...
def start_init_payment(transaction_id):
    ...
    data = {
        ...
        'pg_language': 'ru',
        'pg_testing_mode': '1',
        'pg_success_url': f'{settings.BASE_URL}/paybox/result/success/',
        'pg_failure_url': f'{settings.BASE_URL}/paybox/result/failure/',
...
def save_user_card(user):
    ...
    data = {
        ...
        'pg_back_link': f'{settings.BASE_URL}/paybox/result/card-save/'
    }
